...
public final class ConverterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.unsa.sd.grpc.ConvertRequest,
      edu.unsa.sd.grpc.ConvertResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Convert",
      requestType = edu.unsa.sd.grpc.ConvertRequest.class,
      responseType = edu.unsa.sd.grpc.ConvertResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.unsa.sd.grpc.ConvertRequest,
      edu.unsa.sd.grpc.ConvertResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<edu.unsa.sd.grpc.ConvertRequest, edu.unsa.sd.grpc.ConvertResponse> getConvertMethod;
      ...
      synchronized (ConverterGrpc.class) {
        if ((getConvertMethod = ConverterGrpc.getConvertMethod) == null) {
          ConverterGrpc.getConvertMethod = getConvertMethod =
              io.grpc.MethodDescriptor.<edu.unsa.sd.grpc.ConvertRequest, edu.unsa.sd.grpc.ConvertResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.unsa.sd.grpc.ConvertRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.unsa.sd.grpc.ConvertResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void convert(edu.unsa.sd.grpc.ConvertRequest request,
        io.grpc.stub.StreamObserver<edu.unsa.sd.grpc.ConvertResponse> responseObserver) {
  ...
  public static final class ConverterStub
    ...
    /**
     */
    public void convert(edu.unsa.sd.grpc.ConvertRequest request,
        io.grpc.stub.StreamObserver<edu.unsa.sd.grpc.ConvertResponse> responseObserver) {
  ...
  public static final class ConverterBlockingStub
    ...
    /**
     */
    public edu.unsa.sd.grpc.ConvertResponse convert(edu.unsa.sd.grpc.ConvertRequest request) {
  ...
  public static final class ConverterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.unsa.sd.grpc.ConvertResponse> convert(
        edu.unsa.sd.grpc.ConvertRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((edu.unsa.sd.grpc.ConvertRequest) request,
              (io.grpc.stub.StreamObserver<edu.unsa.sd.grpc.ConvertResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.unsa.sd.grpc.ConvertRequest,
              edu.unsa.sd.grpc.ConvertResponse>(
  ...
  private static abstract class ConverterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.unsa.sd.grpc.ConverterProto.getDescriptor();
    }
