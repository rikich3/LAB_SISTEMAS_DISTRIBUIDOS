...
public class BerkeleyAlgorithm {
    ...
    public static void testBerkeleyAlgorithm() {
        ...
        if (adjustments[0] != 50)
            throw new AssertionError("Test failed for server adjustment");
        if (adjustments[1] != 0)
            throw new AssertionError("Test failed for client 1 adjustment");
        if (adjustments[2] != -50)
            throw new AssertionError("Test failed for client 2 adjustment");
